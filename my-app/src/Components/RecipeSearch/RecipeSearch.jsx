        ...
        <div className="RecipeSearch">
            <div className="RecipeSearch_SearchSide SearchSide">
                ...
                <div className="RecipeSearch_FindArea">
                    <img src={lupa}></img>
                    <input type={'text'} placeholder='Search By ingridients'  onChange={(e)=>{
                     return FindRecepies(e)
                    }}></input>
                    <img className="RecipeSearch_Close" src={close} onClick={CloseSearchWindow}></img>
                </div>
            </div> 
            {console.log(State.Recepies?.FindedRecepies)}
            <div className={State.Recepies?.FindedRecepies?.length>0?"RecipeSearch_FindedRecipes_overflowed FindedRecipes":"RecipeSearch_FindedRecipes FindedRecipes"}>
                  {State.Recepies.FindedRecepies.map((item)=>{
                      return <div className="RecipeSearch_FindedRecept">
            ...
            <div className={State.Recepies.Recepies.length>0?'Changed':"SearchResults"} onClick={CloseSearchWindow}>123</div>
        </div>
    )
}